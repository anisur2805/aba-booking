...
class Courses_Metabox {
    ...
    public function render_courses_metabox( $post ) {
        ...
        $agenda = get_post_meta( $post->ID, 'aba_course_agenda', true );
        ...
        <div class="aba_booking_metabox_wrapper">
            ...
            <div class="aba_booking_form_group">
                <label for="aba_course_agenda">
                    <?php _e( 'Course Agenda' ,'aba_booking' ); ?>
                </label>
                <textarea name="aba_course_agenda" id="aba_course_agenda" placeholder="Course Agenda" class="regular-text"><?php echo $agenda; ?></textarea>
            </div>
    ...
    public function save( $post_id ) {
        ...
        if( isset( $_POST['aba_course_agenda'] ) ) {
            update_post_meta($post_id, 'aba_course_agenda', sanitize_text_field( $_POST['aba_course_agenda'] ) );
        }

        if( isset( $_POST['aba_booking_course_date'] ) ) {
            update_post_meta($post_id, 'aba_booking_course_date', sanitize_text_field( $_POST['aba_booking_course_date'] ) );
        }
